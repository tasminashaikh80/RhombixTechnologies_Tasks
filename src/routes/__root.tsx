...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lumen — Digital Art Gallery & Community" },
      {
        name: "description",
        content:
          "Lumen is a digital art community where artists showcase portfolios and enthusiasts discover, follow, like and save artwork.",
      },
      { property: "og:title", content: "Lumen — Digital Art Gallery & Community" },
      {
        property: "og:description",
        content: "Discover digital painting, illustration, 3D art, concept art and photography.",
      },
